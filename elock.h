...
#define elock_init(lock, init_val, out_err)                                   \
{                                                                              \
 ...
 *    will block until another thread signals it by calling elock_signal(). */
#define elock_wait(lock, out_err)                                             \
{                                                                              \
    uint64_t val;                                                              \
 ...
 * waiting, the next call to 'elock_wait' will be non-blocking. */
#define elock_signal(lock, out_err)                                           \
{                                                                              \
    uint64_t val = 1;                                                          \
...
/* Destroys the lock. */
#define elock_destroy(lock, out_err)                                          \
{                                                                              \
